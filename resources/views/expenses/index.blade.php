...
@section('actions')
    ...
    <a href="{{ route('expenses.index') }}" class="btn btn-sm btn-outline-secondary me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $expense->id }}">
