...
<span class="print-date">{{ now()->format('Y-m-d') }}</span>
  ...
  <table style="margin-bottom:0px;">
    ...
    <tr>
        <td style="height:70px"  style="width:30%; text-align:right;">العنوان :</td>
         <td style="width:65%; text-align:center;">{{ $shipment->customer_address ?? '-' }}</td>
    </tr>


    {{-- ✅ إضافة خانة الملاحظات --}}
    <tr>
